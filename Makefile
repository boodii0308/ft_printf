...
#    Updated: 2019/09/29 23:43:47 by tebatsai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_DIRECTORY = ./srcs/
SRCS_LIST = make_hex.c make_oct.c\
			make_digit.c make_length.c\
			make_char.c make_str.c\
			make_pointer.c make_unsign.c\
			ft_should2.c make_float.c\
			make_science.c make_pointer.c\
			ft_printf.c ft_get.c ft_should.c make_binary.c
